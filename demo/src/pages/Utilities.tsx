      ...
      <header className="page-header">
        <div className="demo-container">
          ...
          <p className="cyber-lead">
            Low-level utility classes for rapid UI development. Compose layouts, spacing, colors,
            and effects.
          </p>
        </div>
      </header>
        ...
        {activeTab === 'display' && (
          <section className="demo-section">
            ...
            <div className="demo-code-preview">
              ...
              >
                <div
                  className="cyber-block cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
                  <code>.cyber-block</code> - Full width block
                </div>
                <span
                  className="cyber-inline cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
                ...
                <div
                  className="cyber-inline-block cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
            ...
            <div className="demo-code-preview" style={{ marginTop: 'var(--space-xl)' }}>
              <div className="demo-preview">
                <div
                  ...
                  style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                >
                  <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                    Flex 1
                  </div>
                  <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                    Flex 2
...
<div class="cyber-grid">Grid container</div>`}
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-hidden</code>
                    </td>
                    <td>display: none</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-block</code>
                    </td>
                    <td>display: block</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-inline-block</code>
                    </td>
                    <td>display: inline-block</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex</code>
                    </td>
                    <td>display: flex</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-inline-flex</code>
                    </td>
                    <td>display: inline-flex</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-grid</code>
                    </td>
                    <td>display: grid</td>
                  </tr>
                </tbody>
        ...
        {activeTab === 'flex' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Flexbox utilities for controlling flex container behavior, item alignment, and
              spacing. Combine with <code>.cyber-flex</code> from display utilities.
            </p>
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  <code style={{ marginBottom: 'var(--space-xs)', display: 'block' }}>
                    .cyber-flex-row
                  </code>
                  <div
                    className="cyber-flex cyber-flex-row cyber-gap-sm"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      1
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-flex-col cyber-gap-sm"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      1
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-flex-wrap cyber-gap-sm"
                    style={{
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-flex-nowrap cyber-gap-sm"
                    style={{
                      background: 'var(--color-bg-elevated)',
                      padding: 'var(--space-sm)',
                      maxWidth: '280px',
                  ...
                  >
                    <div
                      ...
                      style={{ background: 'var(--cyber-cyan-900)', flexShrink: 0 }}
                    >
                      Item 1
                    </div>
                    <div
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-items-start cyber-gap-sm"
                    style={{
                      background: 'var(--color-bg-elevated)',
                      padding: 'var(--space-sm)',
                      minHeight: '80px',
                  ...
                  >
                    ...
                    <div className="cyber-p-md" style={{ background: 'var(--cyber-cyan-900)' }}>
                      B
                    </div>
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      C
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-items-end cyber-gap-sm"
                    style={{
                      background: 'var(--color-bg-elevated)',
                      padding: 'var(--space-sm)',
                      minHeight: '80px',
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-items-stretch cyber-gap-sm"
                    style={{
                      background: 'var(--color-bg-elevated)',
                      padding: 'var(--space-sm)',
                      minHeight: '80px',
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-justify-start cyber-gap-sm"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-justify-center cyber-gap-sm"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-justify-end cyber-gap-sm"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-justify-between"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-justify-around"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-gap-xs"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-gap-md"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-gap-lg"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
                ...
                <div>
                  ...
                  <div
                    className="cyber-flex cyber-gap-xl"
                    style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-sm)' }}
                  >
                    <div className="cyber-p-sm" style={{ background: 'var(--cyber-cyan-900)' }}>
                      A
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  >
                    <div
                      className="cyber-flex-1 cyber-p-sm"
                      style={{ background: 'var(--cyber-cyan-900)', textAlign: 'center' }}
                    >
                      flex-1
                    </div>
                    <div
                ...
                <div>
                  ...
                  >
                    <div
                      className="cyber-flex-auto cyber-p-sm"
                      style={{ background: 'var(--cyber-cyan-900)', textAlign: 'center' }}
                    >
                      auto (short)
                    </div>
                ...
                <div>
                  ...
                  >
                    <div
                      className="cyber-flex-none cyber-p-sm"
                      style={{ background: 'var(--cyber-cyan-900)' }}
                    >
                      none
                    </div>
                    <div
              ...
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td
                      colSpan={2}
                      style={{ background: 'var(--color-bg-elevated)', fontWeight: 'bold' }}
                    >
                      Direction
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex-row</code>
                    </td>
                    <td>flex-direction: row</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex-col</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-flex-wrap</code>
                    </td>
                    <td>flex-wrap: wrap</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex-nowrap</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-items-start</code>
                    </td>
                    <td>align-items: flex-start</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-items-center</code>
                    </td>
                    <td>align-items: center</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-items-end</code>
                    </td>
                    <td>align-items: flex-end</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-items-stretch</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-justify-start</code>
                    </td>
                    <td>justify-content: flex-start</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-justify-center</code>
                    </td>
                    <td>justify-content: center</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-justify-end</code>
                    </td>
                    <td>justify-content: flex-end</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-justify-between</code>
                    </td>
                    <td>justify-content: space-between</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-justify-around</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-gap-xs</code>
                    </td>
                    <td>gap: var(--space-xs)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-gap-sm</code>
                    </td>
                    <td>gap: var(--space-sm)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-gap-md</code>
                    </td>
                    <td>gap: var(--space-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-gap-lg</code>
                    </td>
                    <td>gap: var(--space-lg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-gap-xl</code>
                    </td>
                    <td>gap: var(--space-xl)</td>
                  </tr>
                  <tr>
                    <td
                      colSpan={2}
                  ...
                  <tr>
                    <td>
                      <code>.cyber-flex-1</code>
                    </td>
                    <td>flex: 1 1 0%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex-auto</code>
                    </td>
                    <td>flex: 1 1 auto</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-flex-none</code>
                    </td>
                    <td>flex: none</td>
                  </tr>
                </tbody>
        ...
        {activeTab === 'grid' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              ...
              stack on smaller screens, while auto-fit grids dynamically adjust based on available
              space.
            </p>
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  <p
                    className="cyber-text-sm cyber-text-muted"
                  ...
                  <div className="cyber-grid--3">
                    <div
                      ...
                      style={{
                        ...
                        border: '1px solid var(--cyber-magenta-500)',
                      }}
                    >
                      1
                    </div>
                ...
                <div>
                  ...
                  <div className="cyber-grid--4">
                    <div
                      className="cyber-p-md"
                      style={{
                        background: 'var(--cyber-yellow-900)',
                        border: '1px solid var(--cyber-yellow-500)',
                      }}
                    >
                      1
                    </div>
            ...
            <div className="demo-code-preview">
              ...
              >
                <div>
                  ...
                  <div className="cyber-grid--4">
                    <div
                      className="cyber-col-span-2 cyber-p-md"
                      style={{
                        background: 'var(--cyber-cyan-700)',
                        border: '1px solid var(--cyber-cyan-400)',
                      }}
                    >
                      Span 2
                    </div>
                    <div
                      ...
                      style={{
                        ...
                        border: '1px solid var(--cyber-chrome-600)',
                      }}
                    >
                      1
                    </div>
                ...
                <div>
                  ...
                  <div className="cyber-grid--4">
                    <div
                      className="cyber-col-span-3 cyber-p-md"
                      style={{
                        background: 'var(--cyber-magenta-700)',
                        border: '1px solid var(--cyber-magenta-400)',
                      }}
                    >
                      Span 3
                    </div>
                ...
                <div>
                  ...
                  <div className="cyber-grid--3">
                    ...
                    <div
                      className="cyber-col-span-full cyber-p-md"
                      style={{
                        background: 'var(--cyber-yellow-700)',
                        border: '1px solid var(--cyber-yellow-400)',
                      }}
                    >
                      Full Width Row
                    </div>
  ...
  <div class="cyber-col-span-full">Full width</div>
        ...
        {activeTab === 'spacing' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Control margin and padding with utility classes. The spacing scale uses fluid values
              that adapt to viewport size: <code>xs</code>, <code>sm</code>, <code>md</code>,{' '}
            ...
            <div className="demo-code-preview">
              ...
              >
                <div style={{ background: 'var(--cyber-magenta-800)', padding: '2px' }}>
                  <div
                    className="cyber-m-0"
                    style={{ background: 'var(--cyber-cyan-800)', padding: 'var(--space-xs)' }}
                  >
                    <code>.cyber-m-0</code>
                  </div>
                </div>
            ...
            <div className="demo-code-preview">
              ...
              >
                <div style={{ background: 'var(--cyber-magenta-800)' }}>
                  <div
                    className="cyber-mx-auto"
                    style={{
                      background: 'var(--cyber-cyan-800)',
...
<div class="cyber-mx-lg">Large horizontal margin</div>`}
            ...
            <div className="demo-code-preview">
              ...
              >
                <div
                  style={{
                    background: 'var(--cyber-magenta-800)',
                    marginBottom: 'var(--space-xs)',
                  }}
                >
                  <div
                    className="cyber-my-sm"
                    style={{ background: 'var(--cyber-cyan-800)', padding: 'var(--space-xs)' }}
                  >
...
<div class="cyber-my-xl">Extra large vertical margin</div>`}
            ...
            <div className="demo-code-preview">
              <div
                className="demo-preview"
                style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 'var(--space-md)' }}
              >
                <div style={{ background: 'var(--cyber-magenta-800)' }}>
                  <div
                    className="cyber-mt-md"
                    style={{ background: 'var(--cyber-cyan-800)', padding: 'var(--space-xs)' }}
                  >
...
<div class="cyber-p-xl">Extra large padding</div>`}
            ...
            <div className="demo-code-preview">
              ...
              >
                <div
                  className="cyber-px-lg cyber-py-xs"
                  style={{
                    background: 'var(--cyber-green-800)',
                    border: '1px solid var(--cyber-green-500)',
                  }}
                >
                ...
                <div
                  className="cyber-px-sm cyber-py-lg"
                  style={{
                    background: 'var(--cyber-yellow-800)',
                    border: '1px solid var(--cyber-yellow-500)',
                  }}
                >
                ...
                <div
                  className="cyber-px-md cyber-py-md"
                  style={{
                    background: 'var(--cyber-magenta-800)',
                    border: '1px solid var(--cyber-magenta-500)',
                  }}
...
<div class="cyber-px-lg cyber-py-sm">Wide button style</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              The spacing utilities use CSS custom properties with fluid values that scale with
              viewport width:
            </p>
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
        ...
        {activeTab === 'text' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Control text appearance including alignment, colors, glow effects, font weights,
              families, transforms, and overflow behavior. These utilities help style typography
            ...
            <div className="demo-code-preview">
              ...
              >
                <div
                  className="cyber-text-left cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
                  <code>.cyber-text-left</code> - Left aligned text
                </div>
                <div
                  className="cyber-text-center cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
                  <code>.cyber-text-center</code> - Center aligned text
                </div>
                <div
                  className="cyber-text-right cyber-p-sm"
                  style={{ background: 'var(--color-bg-elevated)' }}
                >
...
<p class="cyber-text-right">Right aligned text</p>`}
            ...
            <div
              className="cyber-table-wrapper"
              style={{ overflowX: 'auto', marginTop: 'var(--space-lg)' }}
            >
              <table className="cyber-table">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-text-left</code>
                    </td>
                    <td>text-align: left</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-center</code>
                    </td>
                    <td>text-align: center</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-right</code>
                    </td>
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-text-primary</code>
                    </td>
                    <td>color: var(--color-text-primary)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-secondary</code>
                    </td>
                    <td>color: var(--color-text-secondary)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-muted</code>
                    </td>
                    <td>color: var(--color-text-muted)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-cyan</code>
                    </td>
                    <td>color: var(--cyber-cyan-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-magenta</code>
                    </td>
                    <td>color: var(--cyber-magenta-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-yellow</code>
                    </td>
                    <td>color: var(--cyber-yellow-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-green</code>
                    </td>
                    <td>color: var(--cyber-green-500)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-text-glow</code>
                    </td>
                    <td>Cyan</td>
                    <td>text-shadow: var(--glow-text-cyan)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-glow--magenta</code>
                    </td>
                    <td>Magenta</td>
                    <td>text-shadow: var(--glow-text-magenta)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-glow--yellow</code>
                    </td>
                    <td>Yellow</td>
                    <td>text-shadow: var(--glow-text-yellow)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-text-glow--green</code>
                    </td>
                    <td>Green</td>
                    <td>text-shadow: var(--glow-text-green)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-font-normal</code>
                    </td>
                    <td>font-weight: 400</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-font-medium</code>
                    </td>
                    <td>font-weight: 500</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-font-semibold</code>
                    </td>
                    <td>font-weight: 600</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-font-bold</code>
                    </td>
...
<code class="cyber-font-mono">Monospace for code</code>`}
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-font-display</code>
                    </td>
                    <td>font-family: var(--font-display)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-font-body</code>
                    </td>
                    <td>font-family: var(--font-body)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-font-mono</code>
                    </td>
                    <td>font-family: var(--font-mono)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="demo-code-preview">
              ...
              >
                <p
                  className="cyber-uppercase cyber-p-sm"
                  style={{ margin: 0, background: 'var(--color-bg-elevated)' }}
                >
                  Uppercase text with wider tracking
                </p>
                <p
                  className="cyber-lowercase cyber-p-sm"
                  style={{ margin: 0, background: 'var(--color-bg-elevated)' }}
                >
                  LOWERCASE TEXT CONVERSION
                </p>
                <p
                  className="cyber-capitalize cyber-p-sm"
                  style={{ margin: 0, background: 'var(--color-bg-elevated)' }}
                >
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-uppercase</code>
                    </td>
                    <td>text-transform: uppercase; letter-spacing: var(--tracking-wider)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-lowercase</code>
                    </td>
                    <td>text-transform: lowercase</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-capitalize</code>
                    </td>
              ...
              >
                ...
                >
                  <p className="cyber-truncate" style={{ margin: 0 }}>
                    This is a very long line of text that will be truncated with an ellipsis when it
                ...
                >
                  <p className="cyber-line-clamp-2" style={{ margin: 0 }}>
                    This is a multi-line text that will be clamped to two lines. Any content beyond
                    the second line will be hidden and an ellipsis will appear at the end of the
                    visible text.
                  </p>
                  <code style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)' }}>
                    .cyber-line-clamp-2
                ...
                >
                  <p className="cyber-line-clamp-3" style={{ margin: 0 }}>
                    This is a multi-line text that will be clamped to three lines. Any content
                    beyond the third line will be hidden and an ellipsis will appear. This is useful
                    for card descriptions and preview text where you want consistent heights.
                  </p>
                  <code style={{ fontSize: 'var(--text-xs)', color: 'var(--color-text-muted)' }}>
                    .cyber-line-clamp-3
                  </code>
...
<p class="cyber-line-clamp-3">Text clamped to 3 lines...</p>`}
            ...
            >
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-truncate</code>
                    </td>
                    <td>overflow: hidden; white-space: nowrap; text-overflow: ellipsis</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-line-clamp-2</code>
                    </td>
                    <td>display: -webkit-box; -webkit-line-clamp: 2; overflow: hidden</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-line-clamp-3</code>
                    </td>
                    <td>display: -webkit-box; -webkit-line-clamp: 3; overflow: hidden</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {activeTab === 'backgrounds' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Control background colors, gradients, and image properties. From themed surfaces to
              vibrant accent colors and gradient effects.
            </p>
            ...
            <div className="demo-code-preview">
              ...
              >
                <div
                  className="cyber-bg-transparent cyber-p-md"
                  style={{ border: '1px dashed var(--cyber-chrome-600)' }}
                >
...
<div class="cyber-bg-elevated">Elevated surface</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Vibrant accent colors for highlighting content. Subtle variants use 15% opacity for
              softer emphasis.
            </p>
            <div className="demo-code-preview">
              <div
              ...
              >
                <div className="cyber-flex cyber-gap-sm" style={{ flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-cyan cyber-p-md"
                    style={{ minWidth: '140px', color: 'var(--cyber-void-900)' }}
                  >
                ...
                <div className="cyber-flex cyber-gap-sm" style={{ flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-magenta cyber-p-md"
                    style={{ minWidth: '140px', color: 'var(--cyber-void-900)' }}
                  >
                ...
                <div className="cyber-flex cyber-gap-sm" style={{ flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-yellow cyber-p-md"
                    style={{ minWidth: '140px', color: 'var(--cyber-void-900)' }}
                  >
                ...
                <div className="cyber-flex cyber-gap-sm" style={{ flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-green cyber-p-md"
                    style={{ minWidth: '140px', color: 'var(--cyber-void-900)' }}
                  >
...
<div class="cyber-bg-green-subtle">Subtle green</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Deep dark backgrounds from the void color palette. Perfect for creating depth and
              contrast.
            </p>
            <div className="demo-code-preview">
              <div
              ...
              >
                <div
                  className="cyber-bg-void-900 cyber-p-md"
                  style={{ border: '1px solid var(--cyber-chrome-700)' }}
                >
...
<div class="cyber-bg-void-700">Medium void</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Pre-built gradient backgrounds using the accent color palette. All gradients flow at
              135 degrees.
            </p>
            <div className="demo-code-preview">
              <div
              ...
              >
                <div
                  className="cyber-bg-gradient-cyan cyber-p-lg"
                  style={{ color: 'var(--cyber-void-900)' }}
                >
                  <code>.cyber-bg-gradient-cyan</code>
                </div>
                <div
                  className="cyber-bg-gradient-magenta cyber-p-lg"
                  style={{ color: 'var(--cyber-void-900)' }}
                >
                  <code>.cyber-bg-gradient-magenta</code>
                </div>
                <div
                  className="cyber-bg-gradient-yellow cyber-p-lg"
                  style={{ color: 'var(--cyber-void-900)' }}
                >
                  <code>.cyber-bg-gradient-yellow</code>
                </div>
                <div
                  className="cyber-bg-gradient-green cyber-p-lg"
                  style={{ color: 'var(--cyber-void-900)' }}
                >
                  <code>.cyber-bg-gradient-green</code>
                </div>
                <div
                  className="cyber-bg-gradient-cyber cyber-p-lg"
                  style={{ color: 'var(--cyber-void-900)' }}
                >
...
<div class="cyber-bg-gradient-cyber">Cyan-to-Magenta gradient</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Utilities for controlling background size, position, repeat, and attachment. Use with
              background images.
            </p>
            <div className="demo-code-preview">
              <div
              ...
              >
                <div className="cyber-flex cyber-gap-sm" style={{ flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-elevated cyber-p-sm"
...
<div class="cyber-bg-local">Scroll with element</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Control how backgrounds are clipped. The <code>cyber-bg-clip-text</code> class enables
            ...
            <div className="demo-code-preview">
              ...
              >
                <div style={{ display: 'flex', gap: 'var(--space-md)', flexWrap: 'wrap' }}>
                  <div
                    className="cyber-bg-gradient-cyan cyber-bg-clip-border cyber-p-md"
                    style={{
                      border: '4px dashed var(--cyber-void-900)',
                      color: 'var(--cyber-void-900)',
                    }}
                  >
                    <code>.cyber-bg-clip-border</code>
                  </div>
                  <div
                    className="cyber-bg-gradient-magenta cyber-bg-clip-padding cyber-p-md"
                    style={{
                      border: '4px dashed var(--cyber-void-900)',
                      color: 'var(--cyber-void-900)',
                    }}
                  ...
                  <div
                    className="cyber-bg-gradient-yellow cyber-bg-clip-content cyber-p-md"
                    style={{
                      border: '4px dashed var(--cyber-void-900)',
                      color: 'var(--cyber-void-900)',
                    }}
  ...
  Gradient Text
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td colSpan={2}>
                      <strong>Theme Backgrounds</strong>
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-bg-current</code>
                    </td>
                    <td>background-color: currentcolor</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-primary</code>
                    </td>
                    <td>background-color: var(--color-bg-primary)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-secondary</code>
                    </td>
                    <td>background-color: var(--color-bg-secondary)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-tertiary</code>
                    </td>
                    <td>background-color: var(--color-bg-tertiary)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-elevated</code>
                    </td>
                    <td>background-color: var(--color-bg-elevated)</td>
                  </tr>
                  <tr>
                    <td colSpan={2}>
                      <strong>Accent Backgrounds</strong>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>background-color: var(--cyber-cyan-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-cyan-subtle</code>
                    </td>
                    <td>background-color: cyan @ 15% opacity</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-magenta</code>
                    </td>
                    <td>background-color: var(--cyber-magenta-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-magenta-subtle</code>
                    </td>
                    <td>background-color: magenta @ 15% opacity</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-yellow</code>
                    </td>
                    <td>background-color: var(--cyber-yellow-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-yellow-subtle</code>
                    </td>
                    <td>background-color: yellow @ 15% opacity</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-green</code>
                    </td>
                    <td>background-color: var(--cyber-green-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-green-subtle</code>
                    </td>
                    <td>background-color: green @ 15% opacity</td>
                  </tr>
                  <tr>
                    <td colSpan={2}>
                      <strong>Void Scale</strong>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-void-900</code>
                    </td>
                    <td>background-color: var(--cyber-void-900)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-void-800</code>
                    </td>
                    <td>background-color: var(--cyber-void-800)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-void-700</code>
                    </td>
                    <td>background-color: var(--cyber-void-700)</td>
                  </tr>
                  <tr>
                    <td colSpan={2}>
                  ...
                  <tr>
                    ...
                    <td>linear-gradient(135deg, cyan-700, cyan-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-gradient-magenta</code>
                    </td>
                    <td>linear-gradient(135deg, magenta-700, magenta-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-gradient-yellow</code>
                    </td>
                    <td>linear-gradient(135deg, yellow-700, yellow-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-gradient-green</code>
                    </td>
                    <td>linear-gradient(135deg, green-700, green-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-gradient-cyber</code>
                    </td>
                    <td>linear-gradient(135deg, cyan-500, magenta-500)</td>
                  </tr>
                  <tr>
                    <td colSpan={2}>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-bg-left</code>
                    </td>
                    <td>background-position: left</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-right</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-bg-repeat-x</code>
                    </td>
                    <td>background-repeat: repeat-x</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-repeat-y</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-bg-local</code>
                    </td>
                    <td>background-attachment: local</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-bg-scroll</code>
                    </td>
        ...
        {activeTab === 'borders' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Control border width, style, color, and radius. Combine utilities to create custom
              border treatments for cards, buttons, and containers.
            </p>
...
<div class="cyber-rounded cyber-rounded-b-none">No bottom radius</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Ring utilities create focus-ring-like outlines using box-shadow, allowing them to work
              alongside borders without affecting layout.
            </p>
            <div className="demo-code-preview">
              <div className="demo-preview" style={{ gap: 'var(--space-md)', flexWrap: 'wrap' }}>
                <div
...
<div class="cyber-ring-0">No ring</div>`}
            ...
            <h3
              className="cyber-h4"
              style={{ marginTop: 'var(--space-2xl)', marginBottom: 'var(--space-md)' }}
            >
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-border-0</code>
                    </td>
                    <td>border-width: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border</code>
                    </td>
                    <td>border-width: 1px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-2</code>
                    </td>
                    <td>border-width: 2px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-4</code>
                    </td>
                    <td>border-width: 4px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-t</code>
                    </td>
                    <td>border-top-width: 1px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-r</code>
                    </td>
                    <td>border-right-width: 1px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-b</code>
                    </td>
                    <td>border-bottom-width: 1px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-l</code>
                    </td>
                    <td>border-left-width: 1px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-t-0</code>
                    </td>
                    <td>border-top-width: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-r-0</code>
                    </td>
                    <td>border-right-width: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-b-0</code>
                    </td>
                    <td>border-bottom-width: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-l-0</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-border-solid</code>
                    </td>
                    <td>border-style: solid</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-dashed</code>
                    </td>
                    <td>border-style: dashed</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-dotted</code>
                    </td>
                    <td>border-style: dotted</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-none</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-border-default</code>
                    </td>
                    <td>border-color: var(--color-border-default)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-subtle</code>
                    </td>
                    <td>border-color: var(--color-border-subtle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-cyan</code>
                    </td>
                    <td>border-color: var(--cyber-cyan-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-magenta</code>
                    </td>
                    <td>border-color: var(--cyber-magenta-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-yellow</code>
                    </td>
                    <td>border-color: var(--cyber-yellow-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-green</code>
                    </td>
                    <td>border-color: var(--cyber-green-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-border-transparent</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-rounded-none</code>
                    </td>
                    <td>border-radius: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-sm</code>
                    </td>
                    <td>border-radius: var(--radius-sm)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded</code>
                    </td>
                    <td>border-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-md</code>
                    </td>
                    <td>border-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-lg</code>
                    </td>
                    <td>border-radius: var(--radius-lg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-xl</code>
                    </td>
                    <td>border-radius: var(--radius-xl)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-full</code>
                    </td>
                    <td>border-radius: 9999px</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-t</code>
                    </td>
                    <td>border-top-left/right-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-r</code>
                    </td>
                    <td>border-top/bottom-right-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-b</code>
                    </td>
                    <td>border-bottom-left/right-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-l</code>
                    </td>
                    <td>border-top/bottom-left-radius: var(--radius-md)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-t-none</code>
                    </td>
                    <td>border-top-left/right-radius: 0</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rounded-b-none</code>
                    </td>
                    <td>border-bottom-left/right-radius: 0</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-ring</code>
                    </td>
                    <td>box-shadow: 0 0 0 2px var(--cyber-cyan-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-ring-magenta</code>
                    </td>
                    <td>box-shadow: 0 0 0 2px var(--cyber-magenta-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-ring-yellow</code>
                    </td>
                    <td>box-shadow: 0 0 0 2px var(--cyber-yellow-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-ring-green</code>
                    </td>
                    <td>box-shadow: 0 0 0 2px var(--cyber-green-500)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-ring-0</code>
                    </td>
        ...
        {activeTab === 'shadows' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Control box shadows, glow effects, opacity, and backdrop blur. Use standard shadows
              for subtle depth or cyber glow effects for that signature neon aesthetic.
            </p>
            ...
            <div className="demo-code-preview">
              <div
                ...
                style={{
                  ...
                  flexWrap: 'wrap',
                  background:
                    'linear-gradient(135deg, var(--cyber-cyan-500), var(--cyber-magenta-500))',
...
<div class="cyber-backdrop-blur-xl">Extra large blur (24px)</div>`}
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-shadow-none</code>
                    </td>
                    <td>box-shadow: none</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-sm</code>
                    </td>
                    <td>box-shadow: 0 1px 2px 0 rgb(0 0 0 / 5%), 0 1px 3px 0 rgb(0 0 0 / 10%)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow</code>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-shadow-xl</code>
                    </td>
                    <td>
                      box-shadow: 0 20px 25px -5px rgb(0 0 0 / 10%), 0 8px 10px -6px rgb(0 0 0 /
                      10%)
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-2xl</code>
                    </td>
                    <td>box-shadow: 0 25px 50px -12px rgb(0 0 0 / 25%)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-inner</code>
                    </td>
                    <td>box-shadow: inset 0 2px 4px 0 rgb(0 0 0 / 5%)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-shadow-glow</code>
                    </td>
                    <td>box-shadow: var(--glow-cyan)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-glow-magenta</code>
                    </td>
                    <td>box-shadow: var(--glow-magenta)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-glow-yellow</code>
                    </td>
                    <td>box-shadow: var(--glow-yellow)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-shadow-glow-green</code>
                    </td>
                    <td>box-shadow: var(--glow-green)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-opacity-0</code>
                    </td>
                    <td>opacity: 0%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-5</code>
                    </td>
                    <td>opacity: 5%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-10</code>
                    </td>
                    <td>opacity: 10%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-20</code>
                    </td>
                    <td>opacity: 20%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-25</code>
                    </td>
                    <td>opacity: 25%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-30</code>
                    </td>
                    <td>opacity: 30%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-40</code>
                    </td>
                    <td>opacity: 40%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-50</code>
                    </td>
                    <td>opacity: 50%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-60</code>
                    </td>
                    <td>opacity: 60%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-70</code>
                    </td>
                    <td>opacity: 70%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-75</code>
                    </td>
                    <td>opacity: 75%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-80</code>
                    </td>
                    <td>opacity: 80%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-90</code>
                    </td>
                    <td>opacity: 90%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-95</code>
                    </td>
                    <td>opacity: 95%</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-opacity-100</code>
                    </td>
                    <td>opacity: 100%</td>
                  </tr>
                </tbody>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur-none</code>
                    </td>
                    <td>backdrop-filter: blur(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur-sm</code>
                    </td>
                    <td>backdrop-filter: blur(4px)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur</code>
                    </td>
                    <td>backdrop-filter: blur(8px)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur-md</code>
                    </td>
                    <td>backdrop-filter: blur(12px)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur-lg</code>
                    </td>
                    <td>backdrop-filter: blur(16px)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-backdrop-blur-xl</code>
                    </td>
        ...
        {activeTab === 'transforms' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              CSS transform utilities for scaling, rotating, translating, and skewing elements.
...
<div class="cyber--rotate-90">Rotate -90deg</div>`}
            ...
            <div className="demo-code-preview">
              <div
                className="demo-preview"
                style={{ flexDirection: 'column', gap: 'var(--space-md)', alignItems: 'stretch' }}
              >
                <div
                  style={{
                    background: 'var(--color-bg-elevated)',
...
<div class="cyber-origin-top-left cyber-rotate-45">Top left</div>`}
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-scale-0</code>
                    </td>
                    <td>transform: scale(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-50</code>
                    </td>
                    <td>transform: scale(0.5)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-75</code>
                    </td>
                    <td>transform: scale(0.75)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-90</code>
                    </td>
                    <td>transform: scale(0.9)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-95</code>
                    </td>
                    <td>transform: scale(0.95)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-100</code>
                    </td>
                    <td>transform: scale(1)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-105</code>
                    </td>
                    <td>transform: scale(1.05)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-110</code>
                    </td>
                    <td>transform: scale(1.1)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-125</code>
                    </td>
                    <td>transform: scale(1.25)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-150</code>
                    </td>
                    <td>transform: scale(1.5)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-x-0</code>
                    </td>
                    <td>transform: scaleX(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-x-100</code>
                    </td>
                    <td>transform: scaleX(1)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-y-0</code>
                    </td>
                    <td>transform: scaleY(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-scale-y-100</code>
                    </td>
                    <td>transform: scaleY(1)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-rotate-0</code>
                    </td>
                    <td>transform: rotate(0deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rotate-45</code>
                    </td>
                    <td>transform: rotate(45deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rotate-90</code>
                    </td>
                    <td>transform: rotate(90deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-rotate-180</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-translate-x-0</code>
                    </td>
                    <td>transform: translateX(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-translate-x-full</code>
                    </td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-translate-y-0</code>
                    </td>
                    <td>transform: translateY(0)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-translate-y-full</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-skew-x-0</code>
                    </td>
                    <td>transform: skewX(0deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-skew-x-3</code>
                    </td>
                    <td>transform: skewX(3deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-skew-x-6</code>
                    </td>
                    <td>transform: skewX(6deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-skew-x-12</code>
                    </td>
                    <td>transform: skewX(12deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber--skew-x-3</code>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-skew-y-0</code>
                    </td>
                    <td>transform: skewY(0deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-skew-y-3</code>
                    </td>
                    <td>transform: skewY(3deg)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-skew-y-6</code>
                    </td>
                    <td>transform: skewY(6deg)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-origin-center</code>
                    </td>
                    <td>transform-origin: center</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-top</code>
                    </td>
                    <td>transform-origin: top</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-top-right</code>
                    </td>
                    <td>transform-origin: top right</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-right</code>
                    </td>
                    <td>transform-origin: right</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-bottom-right</code>
                    </td>
                    <td>transform-origin: bottom right</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-bottom</code>
                    </td>
                    <td>transform-origin: bottom</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-bottom-left</code>
                    </td>
                    <td>transform-origin: bottom left</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-left</code>
                    </td>
                    <td>transform-origin: left</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-origin-top-left</code>
                    </td>
        ...
        {activeTab === 'animation' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Animation and transition utilities for adding motion to your interface. These
              utilities provide pre-built animations, timing controls, and smooth transitions. All
              animations respect the <code>prefers-reduced-motion</code> media query for
              accessibility.
            </p>
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Ready-to-use animation classes for common effects. Simply add the class to any
              element.
            </p>
...
<div class="cyber-boot">Boot sequence</div>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)' }}>
              Control animation playback state programmatically. Useful for pausing animations on
              hover or based on user interaction.
            </p>
                ...
                <div className="cyber-flex cyber-flex-wrap cyber-gap-md cyber-items-center">
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div
                      ...
                      style={{
                        background: 'var(--cyber-magenta-600)',
                        color: 'var(--cyber-void-900)',
                        minWidth: '80px',
                      }}
                    >
...
<div class="cyber-animate-pulse cyber-duration-slower">Slower pulse</div>`}
            ...
            <div className="demo-code-preview">
              <div className="demo-preview">
                <div className="cyber-flex cyber-flex-wrap cyber-gap-md">
                  <button className="cyber-btn cyber-transition" style={{ cursor: 'pointer' }}>
                    .cyber-transition
                  </button>
                  <button className="cyber-btn cyber-transition-fast" style={{ cursor: 'pointer' }}>
                    .cyber-transition-fast
                  </button>
                  <button className="cyber-btn cyber-transition-slow" style={{ cursor: 'pointer' }}>
                    .cyber-transition-slow
                  </button>
                  <button className="cyber-btn cyber-transition-none" style={{ cursor: 'pointer' }}>
...
<div class="cyber-transition-none">No transition</div>`}
            ...
            <div
              ...
              style={{
                background: 'var(--color-bg-elevated)',
                borderLeft: '4px solid var(--cyber-green-500)',
              }}
            >
              <p style={{ margin: 0 }}>
                <strong>Accessibility Note:</strong> All animation utilities automatically respect
                the
                <code> prefers-reduced-motion: reduce</code> media query. When users have reduced
                motion enabled in their system preferences, animations are disabled and transitions
                are removed. This ensures your interface remains accessible to users who are
                sensitive to motion.
              </p>
            </div>
            <CodeBlock
    ...
    transition: none;
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-animate-pulse</code>
                    </td>
                    <td>Fades opacity between 100% and 50% (2s cycle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-float</code>
                    </td>
                    <td>Floats up and down by 10px (3s cycle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-boot</code>
                    </td>
                    <td>Cyberpunk flicker-in boot sequence (0.8s, forwards)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-glow</code>
                    </td>
                    <td>Pulsing glow with box-shadow (2s cycle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-spin</code>
                    </td>
                    <td>Continuous 360-degree rotation (1s cycle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-ping</code>
                    </td>
                    <td>Radar ping/ripple effect (1s cycle)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-bounce</code>
                    </td>
                    <td>Bouncing up and down (1s cycle)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-animate-none</code>
                    </td>
                    <td>animation: none</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-paused</code>
                    </td>
                    <td>animation-play-state: paused</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-animate-running</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-delay-100</code>
                    </td>
                    <td>animation-delay: 100ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-delay-200</code>
                    </td>
                    <td>animation-delay: 200ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-delay-300</code>
                    </td>
                    <td>animation-delay: 300ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-delay-500</code>
                    </td>
                    <td>animation-delay: 500ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-delay-1000</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-duration-fast</code>
                    </td>
                    <td>animation-duration: 150ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-duration-normal</code>
                    </td>
                    <td>animation-duration: 300ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-duration-slow</code>
                    </td>
                    <td>animation-duration: 500ms</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-duration-slower</code>
                    </td>
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <code>.cyber-transition</code>
                    </td>
                    <td>Base transition (color, background, border, shadow, transform, opacity)</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-transition-fast</code>
                    </td>
                    <td>Fast transition duration</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-transition-slow</code>
                    </td>
                    <td>Slow transition duration</td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-transition-none</code>
                    </td>
                    <td>Disable all transitions</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {activeTab === 'accessibility' && (
          <section className="demo-section">
            ...
            <p style={{ marginBottom: 'var(--space-lg)' }}>
              Accessibility utilities ensure your interfaces work for all users, including those
              using assistive technologies. These classes help manage screen reader visibility,
              keyboard focus states, and motion preferences.
            </p>
            ...
            <p style={{ marginBottom: 'var(--space-md)', color: 'var(--color-text-muted)' }}>
              Visually hide content while keeping it accessible to screen readers. Essential for
              providing context that sighted users can infer visually.
            </p>
            <div className="demo-code-preview">
              <div
                className="demo-preview"
              ...
              >
                ...
                <div style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-md)' }}>
                  <span className="cyber-text-cyan" style={{ fontSize: '1.5rem' }}>
                    $99.99
                  </span>
...
<nav>...</nav>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)', color: 'var(--color-text-muted)' }}>
              Hidden until focused - perfect for skip links that allow keyboard users to bypass
...
<body>
  ...
  <main id="main-content" tabindex="-1">
    <!-- Main content -->
            ...
            <p style={{ marginBottom: 'var(--space-md)', color: 'var(--color-text-muted)' }}>
              Hide decorative or redundant content from screen readers while keeping it visible. Use
              sparingly - most decorative content should use <code>aria-hidden="true"</code>{' '}
              instead.
            </p>
            <div className="demo-code-preview">
              <div
              ...
              >
                <div style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-md)' }}>
                  <span
                    className="cyber-not-sr cyber-text-cyan"
...
<span aria-hidden="true">Decorative</span>`}
            ...
            <p style={{ marginBottom: 'var(--space-md)', color: 'var(--color-text-muted)' }}>
              Provide clear, visible focus indicators for keyboard navigation. The{' '}
              <code>cyber-focus-visible</code> class adds a prominent cyan outline only when focus
              is from keyboard (not mouse clicks).
            </p>
            <div className="demo-code-preview">
              <div className="demo-preview" style={{ gap: 'var(--space-md)', flexWrap: 'wrap' }}>
                <button className="cyber-btn cyber-focus-visible">Tab to focus me</button>
                <input
                  type="text"
...
<div class="cyber-card cyber-focus-visible"
  ...
  Clickable card
            ...
            <p style={{ marginBottom: 'var(--space-md)', color: 'var(--color-text-muted)' }}>
              Respect user motion preferences for animations and transitions. Some users experience
              motion sickness or have vestibular disorders that make animations problematic.
            </p>
            <div className="demo-code-preview">
              <div
                className="demo-preview"
                style={{ flexDirection: 'column', alignItems: 'stretch', gap: 'var(--space-lg)' }}
              >
                <div style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-md)' }}>
                  <p style={{ marginBottom: 'var(--space-sm)' }}>
                    <code>.cyber-motion-safe</code>
                  </p>
                  <div
...
<div class="cyber-motion-reduce">
  Loading...
            ...
            <div className="demo-code-preview">
              ...
              >
                <div style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-md)' }}>
                  <p style={{ marginBottom: 'var(--space-sm)', fontWeight: 'bold' }}>
                    Accessible Icon Button
                  </p>
                  <button
                    className="cyber-btn cyber-btn--ghost cyber-focus-visible"
                    aria-label="Settings"
                  >
                ...
                <div style={{ background: 'var(--color-bg-elevated)', padding: 'var(--space-md)' }}>
                  <p style={{ marginBottom: 'var(--space-sm)', fontWeight: 'bold' }}>
                    Form with Accessible Error
                  </p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xs)' }}>
                    <label htmlFor="email-demo" className="cyber-label">
                      Email
                    </label>
                    <input
                      id="email-demo"
            ...
            <div className="cyber-table-wrapper" style={{ overflowX: 'auto' }}>
              <table className="cyber-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-sr-only-focusable</code>
                    </td>
              ...
              <table className="cyber-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      position: absolute; width: 1px; height: 1px; margin: -1px; padding: 0; border:
                      0; overflow: hidden; white-space: nowrap; clip: rect(0,0,0,0)
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <code>.cyber-sr-only-focusable:focus</code>
                    </td>
                    <td>
                      position: static; width: auto; height: auto; margin: inherit; padding:
                      inherit; overflow: visible; white-space: normal; clip: auto
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      <code>.cyber-focus-visible:focus-visible</code>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      @media (prefers-reduced-motion: no-preference) transition: none; animation:
                      none
                    </td>
                  </tr>
                </tbody>
